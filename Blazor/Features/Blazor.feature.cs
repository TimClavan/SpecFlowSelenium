...
namespace Blazor.Features
{
    ...
    [NUnit.Framework.TestFixtureAttribute(TestName="Blazor")]
    [NUnit.Framework.DescriptionAttribute("\tIn order to avoid silly mistakes\r\n\tAs a math idiot\r\n\tI want to be told the sum o" +
        "f two numbers")]
    public partial class BlazorFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Blazor", "\tIn order to avoid silly mistakes\r\n\tAs a math idiot\r\n\tI want to be told the sum o" +
        ...
        public virtual void NavigateToTheBlazorHomepageAndCheckItOut()
        {
            string[] tagsOfScenario = new string[] {
                    "mytag"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Navigate to the Blazor homepage and check it out", null, new string[] {
                        "mytag"});
#line 7
